...
@Component
public class CardSummaryMapper implements
        ResponseDtoMapper<CardDtoResponse, CardSumaryProjection>,
    ...
    @Override
    public CardDtoResponse toResponseDto(CardSumaryProjection projection) {
