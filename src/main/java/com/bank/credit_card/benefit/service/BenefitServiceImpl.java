...
import com.bank.credit_card.benefit.exception.BenefitPersistanceException;
...
public class BenefitServiceImpl implements BenefitService {
    ...
    public void delete(Long cardId) {
        var entity = benefitJpaRepository.findActiveByCardId(cardId).orElseThrow();
    ...
    public BigDecimal discount(BigDecimal amount, Integer usedPoints, Long cardId) {
        ...
        var entity = benefitJpaRepository.findActiveByCardId(cardId).orElseThrow(
                () -> new BenefitPersistanceException(AMOUNT_NOT_NULL));

        isNotConditional(entity.getTotalPoints() < usedPoints,
                new BenefitPersistanceException(NOT_ENOUGH_POINTS));
