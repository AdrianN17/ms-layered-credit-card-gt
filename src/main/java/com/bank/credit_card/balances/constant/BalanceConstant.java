...
public class BalanceConstant {
    ...
    public static final String BALANCE_OF_CARD_NOT_FOUND = "Balance of this Card not found";
    public static final String CARD_ACCOUNT_DATA_ID_NOT_FOUND = "Card Account data of card with id not found";
